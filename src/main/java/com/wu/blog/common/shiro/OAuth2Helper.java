...
import com.wu.blog.common.exception.AuthcTypeNotSupportException;
...
public class OAuth2Helper {
     ...
     * 获取所有 OAuth2 配置对象
     */
    private Map<AuthcTypeEnum, BlogProperties.Provider> getAllProvider() {
     ...
     */
    public BlogProperties.Provider getProvider(AuthcTypeEnum identifyType) {
    ...
    public AuthRequest getAuthRequest(AuthcTypeEnum authcTypeEnum) {
        BlogProperties.Provider provider = getProvider(authcTypeEnum);
        if (provider == null) {
