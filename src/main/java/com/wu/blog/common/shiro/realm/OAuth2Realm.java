...
import com.wu.blog.common.shiro.token.OAuth2Token;
...
public abstract class OAuth2Realm extends AuthenticatingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        if (isAuthenticated) {
            userAuths = userAuthsService.selectOneByIdentityTypeAndUserId(getAuthcTypeEnum(), ShiroUtils.getCurrentUser().getUserId());
        } else {
