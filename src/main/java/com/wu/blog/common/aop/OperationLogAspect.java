...
@Aspect
@Component
@ConditionalOnProperty(value="blog.log.operation",havingValue = "true")
public class OperationLogAspect {

    @Resource
    private SysLogMapper sysLogDao;

    @Pointcut("@annotation(com.wu.blog.common.annotation.OperationLog)")
    ...
    private void saveLog(ProceedingJoinPoint jionPoint, long time) {
        MethodSignature signature=(MethodSignature)jionPoint.getSignature();
        ...
        // 请求的方法名
        String className=jionPoint.getTarget().getClass().getName();
