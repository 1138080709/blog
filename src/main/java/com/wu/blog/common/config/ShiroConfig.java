...
import com.wu.blog.common.shiro.EnhanceModularRealmAuthenticator;
import com.wu.blog.common.shiro.credential.RetryLimitHashedCredentialsMatcher;
import com.wu.blog.common.shiro.OAuth2Helper;
import com.wu.blog.common.shiro.RestShiroFilterFactoryBean;
import com.wu.blog.common.shiro.filter.OAuth2AuthenticationFilter;
import com.wu.blog.common.shiro.filter.RestAuthorizationFilter;
import com.wu.blog.common.shiro.filter.RestFormAuthenticationFilter;
import com.wu.blog.common.shiro.realm.OAuth2GiteeRealm;
import com.wu.blog.common.shiro.realm.OAuth2GithubRealm;
...
public class ShiroConfig {
    ...
    public RedisCacheManager redisCacheManager() {
        ...
        redisCacheManager.setExpire(blogProperties.getPermsCacheTimeout()==null?3600: blogProperties.getPermsCacheTimeout());
    ...
    public RedisSessionDAO redisSessionDAO() {
        ...
        redisSessionDAO.setExpire(blogProperties.getSessionTimeout() == null ? 1800 : blogProperties.getSessionTimeout());
