...
public class UserController {
    ...
    public PageResultBean<User> getList(@RequestParam(value="page", defaultValue = "1") int page,
                                        ...
                                        User userQuery) {
        List<User> users=userService.selectAllWithInfo(page,limit,userQuery);
